   ...
   <div  class="container grid grid-cols-8 gap-5 mx-auto h-full">
      ...
      <div class="col-span-2">
        <div class="sticky top-70 mr-28 flex flex-col justify-center items-center">
          <!-- 点赞 -->
          <button @click="isLike = !isLike" class="mt-14 p-2 flex justify-center items-center rounded-full hover:bg-gray-200 dark:hover:bg-gray-700">
            <svg :class="{'text-blue-400': isLike}" class="w-8 h-8" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
          ...
          <!-- 收藏 -->
          <button @click="isMark = !isMark" :class="{'bg-blue-200': isMark}" class="mt-14 mb-14 p-2 rounded-full hover:bg-gray-200 dark:hover:bg-gray-700">
            <svg v-if="!isMark" xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-bookmark-plus" viewBox="0 0 16 16">
              <path d="M2 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v13.5a.5.5 0 0 1-.777.416L8 13.101l-5.223 2.815A.5.5 0 0 1 2 15.5V2zm2-1a1 1 0 0 0-1 1v12.566l4.723-2.482a.5.5 0 0 1 .554 0L13 14.566V2a1 1 0 0 0-1-1H4z"/>
              <path d="M8 4a.5.5 0 0 1 .5.5V6H10a.5.5 0 0 1 0 1H8.5v1.5a.5.5 0 0 1-1 0V7H6a.5.5 0 0 1 0-1h1.5V4.5A.5.5 0 0 1 8 4z"/>
            </svg>
            <svg v-if="isMark" class="bi bi-bookmark-check text-blue-500" xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" viewBox="0 0 16 16">
...
export default defineComponent({
  ...
  setup () {
    ...
    return { isLike, isMark, articleDetail, showEdit }
  }
})
</script>
