<template>
    ...
    class="w-full flex p-4 h-52 border dark:border-gray-700 border-b-0 bg-white dark:bg-gray-800">
        ...
        <!-- Picture -->
        <div class="flex w-32 mr-12 font-Poppins">
            <!-- edit -->
            <div class="flex flex-shrink-0">
                <div class="pr-2 py-2">
                    <a :href="`/draft/${draft.id}`" target="_blank" class="
                    py-1 px-3 rounded-lg border border-blue-400 hover:bg-blue-50 translate duration-150
            ...
            <div class="flex flex-shrink-0">
                <div class="pr-2 py-2">
                    <button  @click.prevent="isModal = true, onClick(draft.id)" class="
                    py-1 px-2 rounded-md hover:bg-gray-3 text-sm text-bookmark-red dark:text-bookmark-red translate duration-150">
