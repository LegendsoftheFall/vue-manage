...
export default defineComponent({
  ...
  setup () {
    ...
    onMounted(() => {
      store.dispatch('searchArticleListOnce', { page: 1, size: 10, category: 'top', key: key.value })
    ...
    useScrollLoad('searchArticleList', total, { page: 2, size: 10, category: 'top', key: key.value })
